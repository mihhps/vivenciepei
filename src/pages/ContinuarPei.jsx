...
export default function ContinuarPei() {
  ...
  return (
    ...
    >
      ...
      <p>
        <strong>Turma:</strong> {peiAntigo.turma}
      </p>
      ...
      >
        {Object.keys(estrutura).map((area) => (
          <button
            ...
            style={{
              padding: 10,
              backgroundColor: areaAtiva === area ? "#0288d1" : "#ccc",
              color: "#fff",
              border: "none",
              borderRadius: 6,
            }}
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    atualizarCampo(idx, "objetivos", e.target.value.split("\n"))
                  }
